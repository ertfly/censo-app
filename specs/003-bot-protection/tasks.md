...
- [ ] T022 [P] [US1] Acrescentar ao `backend/test/helpers/` um `create-test-server.ts` que monta o servidor completo sobre o banco de teste com segredos e `ALTCHA_COST`/`ALTCHA_COUNTER_MAX` baixos definidos só no teste
