...
- [ ] T054 [P] [US1] Teste E2E `e2e/tests/municipality-search.spec.ts`: quickstart cenários 1, 3, 5, 6 e 11; e, na stack `compose.e2e-protection.yaml`, `e2e/tests/protection/search-session-expiry.spec.ts`: a sessão expira durante a digitação e as sugestões aparecem sem apagar o texto (spec 003, US1 cenário 9)
