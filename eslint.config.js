...
export default defineConfigWithVueTs(
    ...
    vueTsConfigs.recommended,
    {
        ...
        settings: {
            ...
            'boundaries/elements': [
                { type: 'be-domain', pattern: 'backend/src/domain' },
                {
                    type: 'be-application',
                    pattern: 'backend/src/application',
                },
                { type: 'be-infra', pattern: 'backend/src/infra' },
                { type: 'contracts', pattern: 'packages/contracts' },
                { type: 'fe-app', pattern: 'frontend/src/app' },
                {
                    type: 'fe-page',
                ...
                { type: 'fe-shared', pattern: 'frontend/src/shared' },
            ],
        },
        rules: {
